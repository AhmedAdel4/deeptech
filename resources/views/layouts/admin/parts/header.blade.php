        ...
        <ul class="nav navbar-nav align-items-center ml-auto">
            <li class="nav-item dropdown dropdown-language">
                ...
                <div class="dropdown-menu dropdown-menu-right" aria-labelledby="dropdown-flag">
                    <a class="dropdown-item" href="{{ route('lang', 'ar') }}" data-language="sa"><i
                            class="flag-icon flag-icon-sa"></i>
                        العربية</a>
                    <a class="dropdown-item" href="{{ route('lang', 'en') }}" data-language="us"><i
            ...
            <li class="nav-item dropdown dropdown-user"><a class="nav-link dropdown-toggle dropdown-user-link"
                    ...
                    <span class="avatar">
                        ...
                        @if ($logo && $logo->getLogoImage() != null)
                            <img class="round" src="{{ $logo->getLogoImage()->original_url }}"
                                alt="avatar" height="40" width="40"><span class="avatar-status-online"></span>
                        @else
                            <img class="round" src="{{ asset('app-assets/images/logo/Deep Programming logo.jpg') }}"
                                alt="avatar" height="40" width="40"><span class="avatar-status-online"></span>
                        @endif
